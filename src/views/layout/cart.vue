<template>
  <div class="cart">
    ...
    <div class="cart-title">
      ...
      <span class="edit" @click="editing = !editing">
        <van-icon name="edit" />
        {{ editing ? '完成' : '编辑'}}
      </span>
    </div>
    ...
    <div class="cart-list">
      <div class="cart-item" v-for="item in cartList" :key="item.goods_id">
        <van-checkbox @click="toggleCheck(item.goods.goods_id)" :value="item.isChecked"></van-checkbox>
        <div class="show">
...
export default {
  ...
  methods: {
    ...
    toggleAllCheck () {
      this.$store.commit('cart/toggleAllCheck', !this.isCheckedAll)
    },
