    ...
    <div class="comment">
      ...
      <div class="comment-list">
        <div class="comment-item" v-for="item in list" :key="item.comment_id">
          <div class="top">
            <img :src="item.user.avatar_utl || defaultImg" alt="">
...
export default {
  ...
  methods: {
    ...
    async getGoodsDetail () {
      ...
      this.detail = detail
      this.images = detail.goods_images.map(image => image.external_url)
      console.log(detail)
    },
    async getProductComment () {
      const { data: { list, total } } = await getProductComment(this.goodsId, 4)
      this.list = list
      this.total = total
    },
